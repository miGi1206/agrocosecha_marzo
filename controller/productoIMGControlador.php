...
if ($peticionAjax) {
    require_once "../model/productoIMGModelo.php";
} else {
    require_once "./model/productoIMGModelo.php";
}

class productoIMGControlador extends productoIMGModelo
{
    /*------------- CONTROLADOR AGREGAR IMAGENES PRODUCTO -----------------------*/
    public function agregar_producto_imagen_controlador()
    {
        ...
        $agregar_productoIMG = productoIMGModelo::agregar_producto_imagenes_modelo($datos_productoIMG_add);
    ...
    public function eliminar_producto_imagen_controlador()
    {
        ...
        $eliminar_producto_imagen = productoIMGModelo::eliminar_producto_imagenes_modelo($id);
